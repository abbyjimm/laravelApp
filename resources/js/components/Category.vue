        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" @click="openModal('category', 'insert')" class="btn btn-secondary">
                        ...
                        <tbody>
                            <tr v-for="category in arrayCategory" :key="category.id">
                                <td>
                                    ...
                                    <template v-else>
                                        <button type="button" class="btn btn-info btn-sm" @click="ableCategory(category.id)">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div v-show="errorCategory" class="form-group row div-error">
                                <div class="text-center text-error">
                                    <div v-for="error in errorShowMsgCategory" :key="error" v-text="error">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="typeAction==1" class="btn btn-primary" @click="insertCategory()">Guardar</button>
        ...
        methods :{
            ...
            disableCategory(id){
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    title: '¿Está seguro que desea desactivar categoría?',
                    type: 'warning',
            ...
            ableCategory(id){
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    swalWithBootstrapButtons.fire({
                    title: '¿Está seguro que desea activar categoría?',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Aceptar',
            ...
            validateCategory(){
                ...
                if(!this.name) this.errorShowMsgCategory.push("El nombre de la categoria no puede estar vacio");
                
                if(this.errorShowMsgCategory.length) this.errorCategory = 1;
