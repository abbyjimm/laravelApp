                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="contact" class="form-control" placeholder="Contacto">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="email-input">Telefono de Contacto</label>
                                <div class="col-md-9">
                                    <input type="text" v-model="contact_tel" class="form-control" placeholder="Telefono de Contacto">
                                </div>
                            </div>
        ...
        methods :{
            listPeople(page, search, criteria){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayPeople= resp.supplier.data;
